...
/**
 * Exceção a ser lançada na ocorrência de falhas e validações de negócio referentes a entidade {@link Perfil}.
 *
 * @author BitWork.
 */
public class PerfilException extends BusinessException {
	 ...
	 * @author BitWork.
	 */
	public PerfilException(final String message, final Throwable e) {
		super(message, e);
	}
